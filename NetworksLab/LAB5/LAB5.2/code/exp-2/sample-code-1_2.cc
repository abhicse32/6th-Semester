...
//       n1 ---+      +--- n3
//
// - All links are P2P with 1050kb/s and 2ms
...
int main (int argc, char *argv[])
{
  ...
  std::string lat = "2ms";
  std::string rate = "1100kb/s"; // P2P link
...
//
  ...
  ApplicationContainer sinkApps = packetSinkHelper1.Install (c.Get (2)); //n2 as sink
  ...
  Ptr<OutputStreamWrapper> stream1 = asciiTraceHelper1.CreateFileStream ("/home/abhishek/Desktop/TcpVariants1.cwnd");
  ...
  app->Setup (ns3TcpSocket, sinkAddress, 1040, 100000, DataRate ("350Kbps"));
  ...
  Ptr<OutputStreamWrapper> stream2 = asciiTraceHelper2.CreateFileStream ("/home/abhishek/Desktop/TcpVariants2.cwnd");
  ...
  app2->Setup (ns3TcpSocket2, sinkAddress2, 1040, 100000, DataRate ("350Kbps"));
  ...
  Ptr<OutputStreamWrapper> stream3 = asciiTraceHelper3.CreateFileStream ("/home/abhishek/Desktop/TcpVariants3.cwnd");
  ns3TcpSocket3->TraceConnectWithoutContext ("CongestionWindow", MakeBoundCallback (&CwndChange, stream3));
  // Create TCP application at n1
  Ptr<MyApp> app3 = CreateObject<MyApp> ();
  app3->Setup (ns3TcpSocket3, sinkAddress3, 1040, 100000, DataRate ("350Kbps"));
  ...
  p2p.EnableAsciiAll (ascii.CreateFileStream ("/home/abhishek/Desktop/TcpVariants1.tr"));
...
//
  ...
  if (enableFlowMonitor)
  {
    ...
    flowmon->SerializeToXmlFile("/home/abhishek/Desktop/TcpVariants1.flowmon", true, true);
